  ...
  en: {
    ...
    settings: {
        ...
        ai: {
            ...
            statusOk: 'OK',
            statusBad: 'FAIL',
            missingNewKey: 'New platforms must provide API key.',
        },
    },
    contextMenu: {
        copy: 'Copy',
  ...
  zho: {
    ...
    settings: {
        ...
        ai: {
            ...
            loggedIn: '已登录',
            notLoggedIn: '未登录',
            passwordPlaceholder: '管理密码',
            login: '登录',
            logout: '退出',
            platforms: 'Gemini 平台列表',
            add: '新增',
            save: '保存',
            baseUrl: 'Base URL',
            model: '模型',
            ...
            statusOk: '可用',
            statusBad: '异常',
            missingNewKey: '新增平台必须填写密钥（已有平台可留空表示不变）。',
        },
    },
    contextMenu: {
        copy: '复制',
